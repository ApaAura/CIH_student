namespace B1
{
    public partial class Form1 : Form
    {
        ...
        private void Default()
        {
            ...
            label1 = new Label();
            label1.Text = "Suprafata : ";
            label1.Location = new Point(30,200);
            label1.Size = new Size(200,30);
            Controls.Add(label1);

            label2 = new Label();
            label2.Text = "Lungimea : ";
        ...
        {
            double raza = double.Parse(text.Text);
            double suprafata = Math.Pow(raza, 2) * Math.PI;
            double lungimea = 2 * Math.PI * raza;
            label1.Text = $"Suprafata : {suprafata:F3} cm^2";
            label2.Text = $"Lungimea : {lungimea:F3} cm";
        }
    }
}